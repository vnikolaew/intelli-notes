...
const NotFound = ({}: NotFoundProps) => {
   return (
      <section className={cn(`flex flex-col items-center p-12 min-h-[70vh] gap-4 font-sans w-full justify-center`)}>
         ...
         <InteractiveLink underlineClassname={`bg-black`} className={`inline-flex gap-2 items-center mt-8 text-lg`} href={`/`}>Go back home <ArrowRight size={22}/></InteractiveLink>
      </section>
   );
};
